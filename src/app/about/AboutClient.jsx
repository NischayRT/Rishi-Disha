        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/book" rel="noopener noreferrer" className="px-6 py-2.5 bg-[#25D366] text-white rounded-md hover:bg-[#20b858] transition font-medium text-sm flex items-center gap-2">
