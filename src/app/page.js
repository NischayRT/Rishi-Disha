...
export default function Home() {
  const services = [
    { 
      title: "Kundali / Birth Chart Reading", 
      desc: "Unlock the secrets of your destiny through a detailed analysis of your birth chart, planetary positions, and life path.", 
      icon: "☉" 
    },
    { 
      title: "Vaastu Shastra Consultation", 
      desc: "Harmonize your living and working spaces with the five elements to invite prosperity, health, and peace.", 
      icon: "⊕" 
    },
    { 
      title: "Remedies & Homas", 
      desc: "Authentic Vedic remedies, poojas, and homas performed with strict adherence to shastras to mitigate planetary doshas.", 
      icon: "🔥" 
    },
    { 
      title: "Devata Prathista", 
      desc: "Expert guidance and conduction of deity installation ceremonies (Prathista) for homes and temples.", 
      icon: "🕉" 
    },
    { 
      title: "Gems, Crystals, & Rudraksha", 
      desc: "Personalized recommendations for authentic gemstones, healing crystals, and Rudraksha to enhance planetary benefits.", 
      icon: "💎" 
    },
    { 
      title: "Career & Finance Astrology", 
      desc: "Navigate career decisions and financial opportunities aligned with your planetary strengths.", 
      icon: "♄" 
    },
  ];
  ...
  const testimonials = [
    {
      name: "Priya Sharma",
      location: "Mumbai",
      review: "RishiDisha transformed our home with Vaastu guidance. Within months, we noticed a remarkable shift in family harmony and financial stability. Truly life-changing."
    },
    {
      name: "Rajesh Verma",
      location: "Delhi",
      review: "The Kundali reading was incredibly accurate. The career guidance I received helped me make a pivotal decision that changed my professional life for the better."
    },
    {
      name: "Anita Patel",
      location: "Ahmedabad",
      review: "Marriage compatibility consultation gave us deep insights. We are now happily married and grateful for the wisdom shared. Highly recommend to every family."
    }
  ];
  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      ...
      {/* 1. Hero Section */}
      <section className="w-full max-w-7xl mx-auto px-4 relative flex flex-col lg:flex-row items-end justify-between min-h-[85vh]">
        
        {/* Left Side: Text Content */}
        <div className="relative z-40 max-w-2xl w-full lg:w-1/2 pt-3 lg:pt-0 mb-3 lg:mb-6">
          
          {/* UPDATED: Organization Name + Banner Image inline */}
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 md:gap-0 mb-4">
            ...
            {/* New Banner Image next to the text */}
            <img 
              src="/banner-1.webp" 
              alt="Jyotisyalayam Banner" 
              className="h-14 md:h-20 object-contain w-auto sm:mt-0" 
            />
          </div>
          ...
          {/* Linked Services List in Banner */}
          <div className="mb-10">
