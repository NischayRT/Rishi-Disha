...
export default function Home() {
  // Adding the new banner services to the array for the grid section below
  const services = [
    { 
  ...
  return (
    <div className="flex flex-col items-center w-full overflow-hidden">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 relative flex flex-col lg:flex-row items-center justify-between min-h-[85vh]">
        ...
        <div className="relative z-40 max-w-2xl w-full lg:w-1/2 pt-10 lg:pt-0">
          <div className="flex items-center gap-4 text-[#d9901c] text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 relative z-50">
            {/* Custom WhatsApp Button (No Component) */}
            <a 
