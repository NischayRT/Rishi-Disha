...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      // Proceed to payment/submission logic here
    ...
    <div className="w-full flex flex-col items-center">
      ...
      <section className="w-full max-w-4xl mx-auto px-4 py-20 md:py-24 text-center">
        ...
        <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto">
          Ready to begin your journey? Reach out via WhatsApp, call, or fill the form below — we respond promptly.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="bg-[#d9901c]/5 border border-[#d9901c]/20 p-4 rounded-xl text-sm text-slate-400 mb-6">
               <span className="text-[#d9901c] font-bold">Note:</span> For the fastest response, WhatsApp is recommended. Please include your name and the service you are interested in when you message.
            </div>
          ...
          <div className="bg-[#0b0f19] lg:bg-[#111827] lg:border border-slate-800 p-0 lg:p-8 rounded-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-300 mb-2 uppercase tracking-wider">Email (Optional)</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {servicesList.map((service, idx) => (
                      <option key={idx} value={service} className="bg-[#111827] text-white py-2">{service}</option>
                    ))}
                  </select>
              ...
              {/* Submit */}
              <div className="pt-2">
                <button type="submit" className="w-full bg-[#d9901c] text-black font-bold py-4 rounded-md hover:bg-[#c48218] transition flex items-center justify-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"></path></svg>
                  Proceed to Payment
                </button>
                <p className="text-center text-[11px] text-slate-500 mt-4">
                  Next step: scan QR code to pay, then confirm via WhatsApp.
                </p>
              </div>
            </form>
          </div>
